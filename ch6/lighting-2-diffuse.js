// This is a WebGL example that draws a cube that has ambient and diffuse lighting.
...
// Uniform locations
let model_view_loc, projection_loc, color_loc, light_loc, light_src_loc, ka_loc, kd_loc;
...
window.addEventListener('load', function init() {
	...
	let fragShdr = compileShader(gl, gl.FRAGMENT_SHADER, `
		...
		void main() {
			...
			gl_FragColor = ka*color*light + kd*d*color*light + ks*color*light;
