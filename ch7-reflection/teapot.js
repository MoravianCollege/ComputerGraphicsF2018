// This is a WebGL example that draws a teapot with a reflective texture. The world is an outdoor
// scene.
...
window.addEventListener('load', function init() {
	...
	img3.addEventListener('load', on_image_load);
	img4.addEventListener('load', on_image_load);
	img5.addEventListener('load', on_image_load);
	img6.addEventListener('load', on_image_load);
	img1.src = 'img1.png';
	img2.src = 'img2.png';
	img3.src = 'img3.png';
	img4.src = 'img4.png';
	...
	let vertShdr = compileShader(gl, gl.VERTEX_SHADER, `
		...
		const vec4 light_src = vec4(0.0, 100.0, -100.0, 1.0);
	...
	// Create a teapot
	load_obj('teapot.obj', function (verts, texCoords, normals, inds) {
		...
		normals = calc_normals(verts, inds, false);
...
let thetas = [0,0,0], position = [0,0,0], cur_scale = 0.005;
