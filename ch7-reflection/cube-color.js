// This is a WebGL example that draws a cube with a reflective texture. The world is a box with
// colored sides.
...
window.addEventListener('load', function init() {
	...
	let img1 = new ImageData(new Uint8ClampedArray([255, 0, 0, 255]), 1, 1); // red
	let img2 = new ImageData(new Uint8ClampedArray([0, 255, 0, 255]), 1, 1); // green
	let img3 = new ImageData(new Uint8ClampedArray([0, 0, 255, 255]), 1, 1); // blue
	let img4 = new ImageData(new Uint8ClampedArray([0, 255, 255, 255]), 1, 1); // cyan
	let img5 = new ImageData(new Uint8ClampedArray([255, 0, 255, 255]), 1, 1); // magenta
	let img6 = new ImageData(new Uint8ClampedArray([255, 255, 0, 255]), 1, 1); // yellow
	...
	// Load the textures
	load_cubemap_texture(gl, img1, img2, img3, img4, img5, img6, 0, gl.NEAREST);
