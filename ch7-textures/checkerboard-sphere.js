// This is a WebGL example that draws a sphere with a checkboard texture
// utilizing a cube map.
...
window.addEventListener('load', function init() {
	...
	// Load the textures
	load_cubemap_texture(img, img, img, img, img, img);
...
function load_cubemap_texture(xp, xn, yp, yn, zp, zn, idx) {
	...
	// Load the image data into the texture
	// Only the Z images should be flipped
