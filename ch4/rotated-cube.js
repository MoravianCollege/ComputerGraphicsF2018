// This is a WebGL example that draws a cube with each face a different color. The cube is rotated
// so three sides can be seen.
...
window.addEventListener('load', function init() {
	...
	gl.uniformMatrix4fv(transform_loc, false, flatten(rotate(30, 1, 1, 1)));
