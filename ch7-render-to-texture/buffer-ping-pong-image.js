...
window.addEventListener('load', function init() {
	...
	//img.src = '../ch7-image-processing/blocks.jpg'
	img.src = '../ch7-textures/WebGL.png'

	// Add the resize listener
	window.addEventListener('resize', onResize);

	// DO NOT Render the scene until image is loaded
	//render();
});
...
function render_image() {
	...
	gl.uniform1i(texture_loc_texture, 0);
